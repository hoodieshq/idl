 ...
 *
 * Usage:
 *   tsx tests/fixtures/record.ts <program-id> <cluster>
 *
 *   tsx tests/fixtures/record.ts BUYuxRfhCMWavaUWxhGtPP3ksKEDZxCD5gzknk3JfAya mainnet-beta
 *   tsx tests/fixtures/record.ts TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA  devnet
 *
...
async function main(): Promise<void> {
    ...
    if (!rawProgram || !rawCluster) {
        console.error('usage: tsx tests/fixtures/record.ts <program-id> <cluster>');
        process.exit(1);
    }
